...
- Connect all GND pins of the tactile buttons to the GND/Voltage breadboard. For the tactile buttons, it does not matter which of the two pins you choose.
- Connect all GND/VOLT pins of the joystick and the rotary encoders to the GND/Voltage breadbord, plus the pins of the digital ports
...
You will need to identify to which digital ports you have connected the tactile buttons and the rotary encoders to your Arduino 2560 MEGA board (VRX and VRY are connected to pins A0 and A1, so you do not have to bother about these pins):
